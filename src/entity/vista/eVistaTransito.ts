...
class eVistaTransito {
  //id numerico, Varco, descrizione, id_stato
    ...
    constructor(id:number, data_transito: Date, speed: number | null = null, speed_real: number | null = null, varco: eVarco, meteo: enumMeteoTipo | null = null, veicolo: eVeicolo, path_immagine: string | null = null, stato: enumTransitoStato ) {
        this.id = id;
